# Claudia Mai Portfolio

Separate project for the Claudia Mai portfolio. The existing portfolio site is not overwritten.
...
- `script.js` powers filters, controls, and canvas particles.
